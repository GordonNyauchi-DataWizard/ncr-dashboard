    ...
    if rc_description.strip():
        ...
        if st.session_state.rc_selected_category:
            ...
            if save_rc:
                ...
                record = {
                    "DateTime": datetime.datetime.now(ZoneInfo("America/Los_Angeles")),
                    "Type": "Root Cause",
                    "NCR Number": ncr_id,
        ...
        with rc_cols[0]:
            if len(rc_data) > 0:
                ...
                with pd.ExcelWriter(buf, engine="openpyxl") as w:
                    ...
                    rc_export["DateTime"] = rc_export["DateTime"].astype(str)
        ...
        with ca_cols[0]:
            if len(ca_data) > 0:
                ...
                with pd.ExcelWriter(buf, engine="openpyxl") as w:
                    ...
                    ca_export["DateTime"] = ca_export["DateTime"].astype(str)
