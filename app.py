        ...
        try:
            ...
            with c1:
                ...
                fig.update_layout(yaxis=dict(autorange="reversed"), showlegend=False,
                                  ...
                                  plot_bgcolor="#f8fafc", xaxis=dict(tickformat="d"))
            ...
            with c2:
                ...
                fig2.update_layout(font=FONT, margin=dict(l=20,r=80,t=10,b=10), showlegend=True, 
                                   legend=dict(x=0.7, y=0.5, bgcolor="rgba(255,255,255,0.8)"))
            ...
            if "Timestamp" in df.columns:
                ...
                try:
                    ...
                    if len(df_trend) > 0:
                        trend = df_trend.groupby("Date").size().reset_index(name="Count").sort_values("Date")
                        trend["Count"] = trend["Count"].astype(int)
                        fig3 = px.line(trend, x="Date", y="Count", template=T, height=220, markers=True,
